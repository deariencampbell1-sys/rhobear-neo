...
class Config:
    ...
    # --- engine (DeepSeek via the Anthropic-compatible endpoint) ---
    # Flash = fast triage/review; Pro = the heavy builder. Priced at Gemini
    # baseline downstream; DeepSeek is the cheap real engine.
